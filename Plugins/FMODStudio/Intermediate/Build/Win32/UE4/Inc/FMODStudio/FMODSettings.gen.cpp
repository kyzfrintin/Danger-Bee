...
static struct FScriptStruct_FMODStudio_StaticRegisterNativesFCustomPoolSizes
{
	...
	UClass* Z_Construct_UClass_UFMODSettings()
	{
		...
		if (!OuterClass)
		{
...
#endif
			static const UE4CodeGen_Private::FIntPropertyParams NewProp_FileBufferSize = { UE4CodeGen_Private::EPropertyClass::Int, "FileBufferSize", RF_Public|RF_Transient|RF_MarkAsNative, 0x0010000000004001, 1, nullptr, STRUCT_OFFSET(UFMODSettings, FileBufferSize), METADATA_PARAMS(NewProp_FileBufferSize_MetaData, ARRAY_COUNT(NewProp_FileBufferSize_MetaData)) };
#if WITH_METADATA
			...
			static const UE4CodeGen_Private::FPropertyParamsBase* const PropPointers[] = {
				...
				(const UE4CodeGen_Private::FPropertyParamsBase*)&NewProp_FileBufferSize,
	...
	IMPLEMENT_CLASS(UFMODSettings, 1348689228);
